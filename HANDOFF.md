...
마지막 업데이트: **2026-07-21** (한밤의 늑대인간 제작 + 브루마블 수정 / ⚠️늑대인간 표시 버그 조사 중)
...
**다음 작업** (우선순위):
- 🆕 **브루마블 실제 플레이 검증** (Henry가 나중에 확인) — 솔로(더미)·멀티(2~4인) 실행하며: 통행료 배수/독점승/파산순서, 카드 19종 효과·연출, 세금 이벤트창 동기화, 세계여행/올림픽/보너스 흐름, 소유 테두리 구분, 밸런스(금액·확률·건물비). 이탈 시 계속(`onPeerLeft`)은 브루마블 미구현 → 지금은 종료.
